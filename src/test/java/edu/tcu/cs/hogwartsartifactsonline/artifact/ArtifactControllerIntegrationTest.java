...
public class ArtifactControllerIntegrationTest {
    ...
    void testFindArtifactByIdNotFound() throws Exception {
        this.mockMvc.perform(get(this.baseUrl + "/artifacts/123").accept(MediaType.APPLICATION_JSON).header(HttpHeaders.AUTHORIZATION, this.token))
    ...
    void testDeleteArtifactNotFound() throws Exception {
        this.mockMvc.perform(delete(this.baseUrl + "/artifacts/123").accept(MediaType.APPLICATION_JSON).header(HttpHeaders.AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
                .andExpect(jsonPath("$.message").value("Could not find artifact with Id 123 :("))
                .andExpect(jsonPath("$.data").isEmpty());
